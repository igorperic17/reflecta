            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="md:max-w-[60%]">
                ...
                <p className="text-blue-50">
                  We believe that effective mental healthcare requires trust. That's why we've built Reflekta with privacy and security as foundational principles, not afterthoughts.
                </p>
              </div>
