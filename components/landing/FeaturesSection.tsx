      ...
      <div className="container px-4 md:px-6 mx-auto max-w-7xl relative z-10">
        <div className="flex flex-col items-center space-y-4 text-center mb-12">
          ...
          <p className="mx-auto max-w-[700px] text-slate-600 md:text-xl dark:text-slate-300">
            Reflecta combines cutting-edge AI with clinical expertise to enhance therapeutic experiences for both providers and patients.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <FeatureCard
            ...
            description="Reflecta strengthens the connection between therapists and patients, creating a bridge between sessions and supporting continuous care."
